...
*                                pos1-snrmask1,2,3
*           2013/03/11  1.3  add pos1-posopt1,2,3,4,5
...
#define MODOPT  "0:single,5:fixed,6:ppp-kine,7:ppp-static,8:ppp-fixed,9:leo-kin,10:leo-rdn"
...
#define EPHOPT  "0:brdc,1:precise,2:brdc,"
#define NAVOPT  "1:gps+2:comp+4:glo+8:gal"
#define GAROPT  "0:off,1:on,2:autocal"
#define SOLOPT  "0:llh,1:xyz,2:enu,3:sp3"
#define TSYOPT  "0:gpst,1:utc"
#define TFTOPT  "0:tow,1:hms"
#define DFTOPT  "0:deg,1:dms"
#define HGTOPT  "0:ellipsoidal,1:geodetic"
#define GEOOPT  "0:JGM3,1:EGM96,2:egm08 3:EIGEN"
...
EXPORT opt_t sysopts[]={
	...
	{"pos1-geomodel",   3,  (void *)&prcopt_.geomodel,   GEOOPT },
	{"pos1-geoorder",   0,  (void *)&prcopt_.geoorder,   ""     },
